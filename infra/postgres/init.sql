...
CREATE TABLE IF NOT EXISTS listings (
    ...
    CONSTRAINT listings_lat_range_check CHECK (lat IS NULL OR (lat BETWEEN -90 AND 90)),
    CONSTRAINT listings_lng_range_check CHECK (lng IS NULL OR (lng BETWEEN -180 AND 180)),
    amenities       TEXT[],
